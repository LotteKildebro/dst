...
<!--wrapper start-->
    ...
    <div class="cointainer">
        ...
        <div class="col-sm-12 col-m-12 col-l-12 top-text top-text-content">
            <h2>Stansning</h2>
<p>Som led i vores tyndpladebearbejdning, <br>råder Dansk Stålplade Teknik A/S over en Amada Vipros Queen 358 revolverstanser.
...
<div class="cointainer">
    ...
    <p>Som led i vores tyndpladebearbejdning, råder Dansk Stålplade Teknik A/S over en Amada Vipros Queen 358 revolverstanser.
    <br><br>
    Vi stanser op til 1270 x 3000 mm i alt fra rustfrit stål, jern, kobber, aluminium og messing. Den maksimale pladetykkelse ved stansning af rustfrit stål er 4 mm, for jern og aluminium er det 5 mm.
    <br><br>
    Det er en del af Dansk stålplade Teknik A/S’s mission altid at kunne tilbyde vores kunder levering til tiden, uanset mængder. Således er flere medarbejdere uddannet i at betjene stansemaskinen, så vi til enhver tid kan arbejde i døgndrift såfremt det er nødvendigt.<br><br>
